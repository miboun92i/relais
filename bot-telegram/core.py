...
Si un avant-gout a deja ete envoye a ce client, ne promets pas d en renvoyer un : oriente vers paiement ou prestations.
        ...
        async with self.capacity:
            ...
            if latest_client and wants_teaser(latest_client):
                ...
                if chat.get('tease_sent'):
                    teaser_note = '\nCONTEXTE AVANT-GOUT\nTu as deja envoye une video tease a ce client. Ne promets pas d en renvoyer une. Oriente vers paiement ou prestations.\n'
                elif not active:
